...
ReminDoo.util.parseBool = function(v) {return (v=="True") || (v=="true");};
...
ReminDoo.mask = function () {Ext.Viewport.setMasked({xtype:'loadmask',message:"טוען נתונים"});};
					...
					function() {
						if (m.query=="SetNotification") {
			  				if ((m.value=="1") && (m.id=="hc")) {
			  					Ext.Msg.alert("נתקבלה קריאה","רופא");	
			  				}
							if ((m.value=="0") && (m.id=="hc")) {
			  					Ext.Msg.alert("","נסגרה קריאת רופא");	
			  				}
						...
						if (m.query=="SetNotificationStatus") {
							if ((m.value=="1") && (m.id=="hc")) {
			  					Ext.Msg.alert("נתקבל עדכון","קריאת רופא בטיפול");	
			  				}
